...
using Rose.EndPoints.Web.Extentions;
...
namespace Rose.EndPoints.Web.Controllers
{
    public class BaseController : Controller
    {
        ...
        protected RoseServices RoseApplicationContext => HttpContext.RoseApplicationContext();
