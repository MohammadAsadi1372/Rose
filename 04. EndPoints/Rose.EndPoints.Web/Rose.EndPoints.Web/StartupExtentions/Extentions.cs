...
using Rose.Utilities.Services.DependentyInjection;
...
namespace Rose.EndPoints.Web.StartupExtentions
{
    public static class Extentions
    {
        ...
        public static IServiceCollection AddRoseDependencies(this IServiceCollection services,
            params string[] assemblyNamesForSearch)
        {

            var assemblies = GetAssemblies(assemblyNamesForSearch);
            services.AddApplicationServices(assemblies).AddDataAccess(assemblies).AddRoseServices(assemblies).AddCustomeDepenecies(assemblies);
            return services;
        }
