...
using Rose.Messaging.MessageBus.RabbitMq;

namespace Rose.Messaging.MessageBus.RabbitMq;
public class RabbitMqReceiveMessageBus : IReceiveMessageBus, IDisposable
{
    ...
    private readonly RoseConfigurationOptions _configuration;
    private readonly IConnection _connection;
    private readonly IModel _channel;

    private IServiceScopeFactory _serviceScopeFactory;

    public RabbitMqReceiveMessageBus(ILogger<RabbitMqReceiveMessageBus> logger, RoseConfigurationOptions configuration, IServiceScopeFactory serviceScopeFactory, IMessageConsumer messageConsumer)
    {
        _logger = logger;
