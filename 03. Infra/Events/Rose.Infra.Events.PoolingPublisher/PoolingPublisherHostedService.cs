...
namespace Rose.Infra.Events.PoolingPublisher;
public class PoolingPublisherHostedService : IHostedService
{
    ...
    public PoolingPublisherHostedService(RoseConfigurationOptions configuration, IOutBoxEventItemRepository outBoxEventItemRepository, ISendMessageBus messageBus)
    {
