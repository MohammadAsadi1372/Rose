...
public class CommandDispatcher : ICommandDispatcher
{
    ...
    public Task<CommandResult> Send<TCommand>(TCommand command) where TCommand : class, ICommand
    {
        ...
        {
            _stopwatch.Stop();
            _logger.LogInformation(RoseEventId.PerformanceMeasurement, "Processing the {CommandType} command tooks {Millisecconds} Millisecconds", command.GetType(), _stopwatch.ElapsedMilliseconds);
        }
